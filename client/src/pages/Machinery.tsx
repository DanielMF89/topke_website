      ...
      <section className="py-24 bg-zinc-50 min-h-screen">
        <div className="container">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <div className="mt-6">
              <a
                href="https://d2xsxph8kpxj0f.cloudfront.net/310519663043532643/92Rt6gRG83YU52q7K3xNuA/catalogo-maquinaria-topke-2026_36de8618.pdf"
                download="Catalogo-Maquinaria-Topke-2026.pdf"
                className="inline-flex items-center gap-2 border-2 border-primary text-primary hover:bg-primary hover:text-white transition-colors font-bold uppercase tracking-wider px-6 py-3 text-sm"
              >

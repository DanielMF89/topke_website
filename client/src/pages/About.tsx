...
export default function About() {
  ...
  const milestones = [
    ...
    },
    {
      ...
      desc: `${yearsOfExperience} años de experiencia, posicionándose como referente en el sector agroindustrial con un portafolio integral.`
    }
  ];
          ...
          >
            <div>
              <h2 className="text-3xl font-display font-bold text-zinc-900 uppercase mb-4">
                {yearsOfExperience} años de <span className="text-primary">Confianza</span>
              </h2>
            </div>
